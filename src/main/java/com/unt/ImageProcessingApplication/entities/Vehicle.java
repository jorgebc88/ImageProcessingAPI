...
public class Vehicle {
	...
	public Vehicle(Point massCenterLocation, double vehicleSize, boolean counted, boolean isGoingDown,
		...
		this.isGoingUp = isGoingDown ? false : true;
		this.isGoingDown = isGoingDown ? true : false;
	...
	public String toString() {
		return "Centro de masa: " + this.massCenterLocation + " Tama�o: " + this.vehicleSize + " IsGoingUp: "
